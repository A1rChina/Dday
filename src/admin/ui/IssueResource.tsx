...
export function IssueResource() {
  ...
  return (
    <AppPage>
      <AppPageHeader title="出库管理" description="新建和管理出库单" />
      <div style={{ marginBottom: 16 }}>
        <AppDrawerForm
          title="新建出库单"
          trigger={<Button type="primary" icon={<PlusOutlined />}>新建出库单</Button>}
          ...
          <div className="mes-drawer-content">
            <div className="mes-drawer-card">
              ...
              <div className="mes-drawer-form-grid" style={{ gridTemplateColumns: '1fr 1fr' }}>
                <Form.Item label="出库日期" name="issuedDate" rules={[{ required: true }]}><Input type="date" /></Form.Item>
            ...
            <div className="mes-drawer-card">
              <div className="mes-drawer-card-title">出库明细</div>
      ...
      <AppProTable
        ...
        columns={[
          ...
          { title: '出库日期', dataIndex: 'issuedDate' },

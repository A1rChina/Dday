...
export const productCreateSchema = z.object({
  ...
  manufacturing_factory: z.string().trim().max(160).default(''),
  factory: z.string().trim().max(160).default(''),
  unit: z.string().trim().min(1).max(20).default('PCS'),
  profile_code: z.string().trim().max(120).optional(),
